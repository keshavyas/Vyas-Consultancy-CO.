...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-BzU5_70-.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DTAF7e1E.mjs");
...
var manifest = { "90802dada3e3abd94910b2d206a0941c3619e873fd29fa0ef5c768796ebe7044": {
	functionName: "submitEnquiry_createServerFn_handler",
	importer: () => import("./enquiries.functions-DqLOo_-A.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cu06imyf.mjs").then((n) => n.t),
		import("./start-qbl9FZIR.mjs"),
